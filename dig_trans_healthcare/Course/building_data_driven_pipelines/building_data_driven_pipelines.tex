...
\begin{frame}{Digital Transformation of Healthcare}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Critique clinical decision support tools
			\item Evaluate study results and model predictions 
			\item Discuss types of machine learning models
			\item Assess data quality
			\item Calculate economic feasibility of informatics projects
			\item Investigate biases within models
			\item Analyze and evaluate raw data
...
\begin{frame}{Lecture Schedule}
	\begin{enumerate}
		...
		\item Assessing data quality (Data Preparation)
		\item Study Design and Data sources (Data Collection)
