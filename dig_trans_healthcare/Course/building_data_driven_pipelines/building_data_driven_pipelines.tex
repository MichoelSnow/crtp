...
%	\pause[2]
	...
	\end{center}
	\note[item]<2>{First let's talk about the 4 to 5 basic steps in our pipeline, and then we'll break each step down into 1 to 3 sub-steps, and then discuss the components of the individual sub-steps.  The first two parts we'll do together as a group and the last part you will work on in teams}
\end{frame}
