...
\note{
	...
	\begin{itemize}
		...
		\item Is context essential in medicine and do machine learning models need to account for that
	\end{itemize}

}

\begin{frame}{Currently Implemented Pipelines}
	\begin{itemize}
		\item Are some types of CDS more or less ethical?
		\begin{itemize}
			\item Respiratory failure
			\item Spinal cord compression detection and prediction
			\item Patient scheduling
		\end{itemize}
	\end{itemize}
\end{frame}
